...
signal players_turn_ended
	
func end_players_turn() -> void:
	players_turn_ended.emit()

func attempt_movement(relative_pos : Vector2, can_move_here: bool = true) -> void:
	...
	lvl_tween.tween_callback(end_players_turn)
